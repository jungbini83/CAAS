...
if [ $netType == "grid" ]; then
	...
	routecmd="python /usr/local/share/sumo/tools/randomTrips.py -n ./map/${netType}/${netType}.net.xml -e 180 -r ./map/${netType}/${netType}.rou.xml --trip-attributes=departLane=\"best\" departSpeed=\"random\" departPos=\"random\" --intermediate 10 -p 5 -b 0.1 -o ./map/${netType}/${netType}.trips.xml"		
